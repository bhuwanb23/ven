...
const SCENARIOS = [
  ...
  },
  {
    ...
    script: [
      ...
      { kind: 'output', text: '  ├── express@5.2.1', tone: 'muted' },
      { kind: 'output', text: '  ├── body-parser@2.3.0', tone: 'muted' },
      { kind: 'output', text: '  ├── cookie@0.7.2', tone: 'muted' },
      { kind: 'output', text: '  └── … (40 more transitive deps)', tone: 'muted' },
      ...
      { kind: 'output', text: '✔ express@5.2.1 added · ven.toml updated', tone: 'success' },
    ],
  },
  {
    id: 'graph',
    ...
    script: [
      ...
      { kind: 'output', text: '│   │   └── qs@6.14.3', tone: 'muted' },
      { kind: 'output', text: '│   └── accepts@2.0.0', tone: 'muted' },
      { kind: 'output', text: '├── lodash@4.17.21', tone: 'muted' },
      { kind: 'output', text: '└── axios@1.8.4', tone: 'muted' },
      { kind: 'output', text: '    └── follow-redirects@1.15.9  ⚠ GHSA-cxjh-pqwp-8mfp', tone: 'warn' },
